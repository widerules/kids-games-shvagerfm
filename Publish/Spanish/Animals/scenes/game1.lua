...
function scene:enterScene(event)
	...
	animalName = display.newEmbossedText( utils.firstToUpper(data.animalsLocalized[data.animalsNames[index]:lower()]), woodenLayer.x, _CENTERY-_WOODENHEIGHT/2, native.systemFont, _H/10);
