...
local function onHomeButtonClicked ()
    transition.cancel( )
    composer.gotoScene("scenes.scenetemplate", "slideRight", 500)
end
                    ...
                    transition.to (wellDoneLabel,
                        {
                            ...
                            onComplete = function ()
                                ...
                                wellDoneLabel = nil
                                timerPtr = timer.performWithDelay( 300, function () composer.gotoScene("scenes.shadows") end)
                            end
                        })
                end)
            end
