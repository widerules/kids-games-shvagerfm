...
function scene:createScene(event)
	...
	background = display.newImage ("images/background.png", constants.CENTERX, constants.CENTERY)
...
function scene:enterScene(event)
	local group = self.view
		...
		itemName = display.newText (data.shapesLocalized[data.shapes[index]], constants.CENTERX, constants.CENTERY + _IMAGESIZE/2 + _FONTSIZE, native.systemFont, _FONTSIZE)
