...
local rectangle = audio.loadSound("sounds/frectangle.mp3")
local round = audio.loadSound("sounds/fround.mp3")
local oval = audio.loadSound("sounds/foval.mp3")
local triangle = audio.loadSound("sounds/ftriangle.mp3")
local star = audio.loadSound("sounds/fstar.mp3")
...
function scene:enterScene( event )
	...
	titleText = display.newText( "Finden " .. shapesDe[rightIndex], 0, 0, native.systemFont, 46 )
	...
	shape1.yScale = 0.1
	shape1.touch = answer
	transition.to(shape1, {xScale = 1, yScale=1, time=300, transition=easing.outBack})
	...
	shape2.yScale = 0.1
	shape2.touch = answer
	transition.to(shape2, {xScale = 1, yScale=1, time=300, transition=easing.outBack})
	...
	shape3.xScale = 0.1
	shape3.yScale = 0.1
	transition.to(shape3, {xScale = 1, yScale=1, time=300, transition=easing.outBack})
	shape3.touch = answer
