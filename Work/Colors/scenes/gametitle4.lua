...
local function goNextGame()
	--storyboard.gotoScene( "scenes.gametitle5", "slideLeft", 500)
	--storyboard.removeAll( )
end
local function goPrevGame()
        storyboard.gotoScene( "scenes.gametitle3", "slideRight", 800)
        --storyboard.removeAll( )
end
local function play()
	storyboard.gotoScene( "scenes.game4", "fade", 100 )
end
...
titlePic = display.newImage("images/game4/titlepic.png", 0, constants.CENTERY, constants.W/2, 3*constants.W/8)
titlePic.x = 0.7*titlePic.width
group:insert(titlePic)

title = display.newImage( "images/btn4.png",  0, 0, constants.W/4, constants.W/12)
