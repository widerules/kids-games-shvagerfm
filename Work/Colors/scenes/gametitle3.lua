...
local function goNextGame()
	storyboard.gotoScene( "scenes.gametitle4", "slideLeft", 500)
	--storyboard.removeAll( )
end
local function goPrevGame()
        storyboard.gotoScene( "scenes.gametitle2", "slideRight", 800)
        --storyboard.removeAll( )
end
local function play()
	storyboard.gotoScene( "scenes.game3", "fade", 100 )
end
...
titlePic = display.newImage("images/game3/titlepic.png", 0, constants.CENTERY, constants.W/2, 3*constants.W/8)
titlePic.x = 0.7*titlePic.width
group:insert(titlePic)

title = display.newImage( "images/btn3.png",  0, 0, constants.W/4, constants.W/12)
